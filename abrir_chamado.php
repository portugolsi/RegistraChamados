<html>
  <head>
    <meta charset="utf-8" />
    <title>VerdanaTech - Abrir Chamado</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-dark" style = "display: flex;  flex-direction: row; justify-content:flex-start; align-items: center;" >
        ...
        <h3 style='color: white; padding-left: 420px'>Abertura de Chamado</h3>  
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <form action='cadastra_chamado.php' method='post' class="form-horizontal">
                ...
                <div class="form-horizontal">
                  <label class="control-label">Data</label>
                    ...
                    <div class="input-group date">
                      <input name='data'  type="text" class="form-control" id="exemplo" >
